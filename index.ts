...
class FrequencyService {
  ...
  public createDataset(option: Option) {
    ...
    if (option === "bigrams-no-crossing") {
      ...
      return this.bigramsWithoutCrossingDataset;
    }
  }
  ...
  public entropy(dataset: IFrequencyData[]) {
...
const bigramsEntropy = frequencyService.entropy(bigramsFrequencyDataset);
